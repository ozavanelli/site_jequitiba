...
function initMap() {
    ...
    var features = [
        {
            position: new google.maps.LatLng(-22.227913, -49.952739),
            type: 'info'
        }
    ];
